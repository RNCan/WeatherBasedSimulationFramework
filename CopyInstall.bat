...
copy /Y "D:\project\bin\Releasex64\Models\Soil Moisture Index (Annual).mdl" "..\Install\NRCan\Models\Soil Moisture Index (Annual).mdl"
copy /Y "D:\project\bin\Releasex64\Models\Soil Moisture Index (Monthly).mdl" "..\Install\NRCan\Models\Soil Moisture Index (Monthly).mdl"
copy /Y "D:\project\bin\Releasex64\Models\Soil Moisture Index (Daily).mdl" "..\Install\NRCan\Models\Soil Moisture Index (Daily).mdl"
copy /Y "D:\project\bin\Releasex64\Models\Soil Moisture Index QL(Annual).mdl" "..\Install\NRCan\Models\Soil Moisture Index QL(Annual).mdl"
