...
namespace WBSF
{
	...
	double Landsat2::INDICES_FACTOR() { return G_INDICES_FACTOR; }
	void Landsat2::INDICES_FACTOR(double f) { G_INDICES_FACTOR = f; }
	...
	//__int16 Landsat2::GetCaptorFromName(const string& title)
	//{
	...
	//	return TRef;
	//}
	//__int16 Landsat2::GetPathFromName(const string& title)
	//{
	//	__int16 path = -32768;
	...
	//	return path;
	//}
	//__int16 Landsat2::GetRowFromName(const string& title)
	//{
	//	__int16 row = -32768;
