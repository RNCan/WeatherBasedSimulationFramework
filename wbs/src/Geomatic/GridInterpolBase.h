...
namespace WBSF
{
	...
	public:
		...
		enum TExternalDrift { BEST_EXTERNAL_DRIFT = -1, NO_EXTERNAL_DRIFT, ED_ELEV, ED_EXPO, ED_SHORE, ED_ELEV_EXPO, ED_ELEV_SHORE,ED_EXPO_SHORE, ED_ELEV_EXPO_SHORE, ED_LAT_LON_ELEV_EXPO, LAT_LON_ELEV_SHORE, NB_EXTERNAL_DRIFTS };
