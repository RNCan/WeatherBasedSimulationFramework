...
namespace WBSF
{
	...
	CWVariables CNormalsMonth::GetVariables()const
	{
		...
		static const size_t VARIABLES[NB_FIELDS] = { H_TAIR, H_TAIR, H_TAIR, H_TAIR, H_TAIR, H_TAIR, H_TAIR, H_TAIR, H_TAIR, H_PRCP, H_PRCP, H_TDEW, H_RELH, H_RELH, H_WNDS, H_WNDS };
