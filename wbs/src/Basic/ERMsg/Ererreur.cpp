...
//*****************************************************************************
#include "stdafx.h"
#include "basic/ERMsg/ererreur.h"
...
void ERErreur::traduisType(std::string& titre, int type)
{
   switch (type)
   {
      case ERMsg::OK:            titre = "OK";            break;
      case ERMsg::AVERTISSEMENT: titre = "AVERTISSEMENT"; break;
      case ERMsg::ERREUR:        titre = "ERREUR";        break;
      case ERMsg::FATAL:         titre = "FATAL";         break;
      default:                   titre = "INCONNU";       break;
   }
}
