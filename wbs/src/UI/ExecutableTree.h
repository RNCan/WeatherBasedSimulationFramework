...
namespace WBSF
{
	...
	public:
		...
		enum TClass{ UNKNOWN = -1, GROUP, WEATHER_UPDATE, WEATHER_GENERATION, MODEL_EXECUTION, ANALYSIS, FUNCTION_ANALYSIS, MERGE_EXECUTABLE, MAPPING, IMPORT_FILE, INPUT_ANALYSIS, DISPERSAL, SCRIPT_R, COPY_EXPORT, MODEL_PARAMETERIZATION, RATE_FIT, NB_CLASS };
