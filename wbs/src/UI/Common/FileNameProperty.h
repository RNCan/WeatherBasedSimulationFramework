...
namespace WBSF
{
	...
	typedef CStdIndexProperty < IDS_STR_WEATHER_VARIABLES_TITLE, true > CWeatherVariableProperty;
	typedef CStdIndexProperty < IDS_STR_STATISTIC > CStatisticProperty;
	typedef CStdIndexProperty < IDS_WG_GRAPH_SERIE_TYPE_TITLE > CSerieTypeProperty;
	typedef CStdIndexProperty < IDS_STR_LEFT_RIGHT > CYAxisTypeProperty;
	typedef CStdIndexProperty < IDS_WG_GRAPH_FILL_DIR_TITLE > CFillDirectionProperty;
	typedef CStdIndexProperty < IDS_WG_GRAPH_HIST_DIR_TITLE > CHistDirectionProperty;
