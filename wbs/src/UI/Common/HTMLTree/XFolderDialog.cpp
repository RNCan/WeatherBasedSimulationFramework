...
//=============================================================================
{
	...
	if (pWnd && IsWindow(pWnd->m_hWnd))
	{
		...
		strPath = szDir;
		//if( nMessage == CDM_GETFILEPATH )
		//{
		//	TCHAR szDrive[MAX_PATH];
		//	TCHAR szPath[MAX_PATH];
		//	TCHAR szName[MAX_PATH];
		//	TCHAR szExt[MAX_PATH];
		//	::_splitpath_s(szDir, szDrive, MAX_PATH, szPath, MAX_PATH, szName, MAX_PATH, szExt, MAX_PATH);
		//	strPath = szDrive;
		//	strPath += szPath;
		//	if( !strPath.IsEmpty() && strPath.Right(1) == '\\' || strPath.Right(1) == '/')
