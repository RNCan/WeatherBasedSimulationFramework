...
#define SPS_RIGHT_MOVE      0x00000004          //  all the linked down window will be move instead of resize
#define SPS_DOWN_MOVE       0x00000004          //  all the linked down window will be move instead of resize
