...
void ArgumentHandler::displayHelp() {
	...
	std::cout << "    " << "                              shape as the training data without the dependant variable." << std::endl;
	...
	std::cout << "    " << "--minprop VAL                 Lower quantile of covariate distribution to be considered for splitting (MAXSTAT splitrule only)." << std::endl;
	...
	std::cout << "    " << "                              MODE = 2: short." << std::endl;
