...
namespace WBSF
{
	...
	public:
		...
		size_t max_vertices()const { return m_max_segments + 1; }
		//set both method;
		size_t fit_method;
	...
	public:
		...
		std::string GetDescription() { return  std::string("LandTrend version ") + VERSION + " (" + __DATE__ + ")"; }
		...
		void ProcessBlock(int xBlock, int yBlock, CBandsHolder& bandHolder, const std::deque<boost::dynamic_bitset<>>& validity, OutputData& outputData, DebugData& debugData);
