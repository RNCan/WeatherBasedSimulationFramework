...
namespace WBSF
{
	const char* CTrainingCreator::VERSION = "1.2.0";
	...
	CTrainingCreatorOption::CTrainingCreatorOption() :CBaseOptions(false)
	{
		...
		{ 
			...
			{ "-Code", 1, "str", false, "File header title for dependent variable. \"Code\" by default." },
			...
			{ "-ExportAll", 0, "", false, "Export all input columns. Export only dependent and independent variables by default." },
