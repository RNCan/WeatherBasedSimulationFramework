...
CCloudCleanerOption::CCloudCleanerOption()
{
	...
	static const COptionDef OPTIONS[] =
	{
		...
		{ "-Sieve", 1, "nbPixel", false, "Set the minimum number of contiguous pixel to consider it as suspicious. 5 by default." },
	...
	static const CIOFileInfoDef IO_FILE_INFO[] =
	{
		...
		{ "Optional Reference Image", "refImage", "Nb references", "ScenesSize(9)", "B1: Landsat band 1|B2: Landsat band 2|B3: Landsat band 3|B4: Landsat band 4|B5: Landsat band 5|B6: Landsat band 6|B7: Landsat band 7|QA: Image quality|JD: Date(Julian day 1970)" },
