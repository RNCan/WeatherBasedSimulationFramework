...
DiscrValue
	*MaxAttVal=Nil,		/* number of values for each att */
	*Modal=Nil;		/* most frequent value for discr att */

char	*SpecialStatus=Nil;	/* special att treatment */

Definition
	*AttDef=Nil;		/* definitions of implicit atts */
Attribute
	**AttDefUses=Nil;	/* list of attributes used by definition */
...
ContValue
	*AttMean=Nil,		/* means of att values */
