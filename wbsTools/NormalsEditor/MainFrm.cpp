...
int CMainFrame::OnCreate(LPCREATESTRUCT lpCreateStruct)
{
	...
	m_wndMenuBar.SetMenuSizes(CSize(22, 22), CSize(16, 16));//avoid problem when changing language
	...
	m_wndToolBar.RestoreOriginalState();//reload good language	
...
BOOL CMainFrame::CreateDockingWindows()
{
	...
	if (!m_wndProperties.Create(GetCString(IDS_PROPERTIES_WND), this, CRect(0,0,600,400), TRUE, ID_PROPERTIES_WND, WS_CHILD | WS_VISIBLE | WS_CLIPSIBLINGS | WS_CLIPCHILDREN | CBRS_BOTTOM | CBRS_FLOAT_MULTI))
	{
...
//		CMFCMenuBar::ResetAllImages();
		CMFCToolBar::AddToolBarForImageCollection(IDR_MENU_IMAGES);
		
		//m_wndMenuBar.ResetImages();
