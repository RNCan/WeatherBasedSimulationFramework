...
CDailyEditorDoc* COutputView::GetDocument() const
{
...
void COutputView::OnUpdate(CView* pSender, LPARAM lHint, CObject* pHint)
{
	...
	if (lHint == CDailyEditorDoc::INIT || lHint == CDailyEditorDoc::OUTPUT_CHANGE)//|| lHint == CDailyEditorDoc::SELECTION_CHANGE || lHint == CDailyEditorDoc::TASK_CHANGE
	{
