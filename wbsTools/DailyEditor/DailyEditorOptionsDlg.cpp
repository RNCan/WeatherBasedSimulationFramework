...
IMPLEMENT_DYNAMIC(CDailyEditorOptionsDlg, CMFCPropertySheet)

CDailyEditorOptionsDlg::CDailyEditorOptionsDlg(CWnd* pParentWnd, UINT iSelectPage)
...
CDailyEditorOptionsDlg::~CDailyEditorOptionsDlg()
{
}


BEGIN_MESSAGE_MAP(CDailyEditorOptionsDlg, CMFCPropertySheet)
	ON_BN_CLICKED(IDOK, OnFinish)
	ON_WM_DESTROY()
END_MESSAGE_MAP()

/////////////////////////////////////////////////////////////////////////////
// CDailyEditorOptionsDlg message handlers
void CDailyEditorOptionsDlg::OnFinish()
{
	m_nModalResult = IDOK;
...
void CDailyEditorOptionsDlg::OnDestroy() 
{
...
BOOL CDailyEditorOptionsDlg::OnInitDialog()
{
