...
public:
	...
	enum TInput{ LOC_FILEPATH, OBSERVATION_TYPE, HOURLY_FILEPATH, DAILY_FILEPATH, NORMALS_FILEPATH, VARIABLES, YEAR, NB_STATIONS, NB_INPUTS };
	enum TInputType{ IT_FILEPATH, IT_OBS_TYPE, IT_VAR, IT_STRING, NB_INPUT_TYPE };
