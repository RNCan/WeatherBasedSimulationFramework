...
public:
	...
	enum { FIRST_PARAM = CStdCmdLine::NB_PARAM, VARIABLE = FIRST_PARAM, YEAR, NB_STATIONS, OBS_TYPE, NORMALS_FILEPATH, DAILY_FILEPATH, HOURLY_FILEPATH, NB_ALL_PARAM, NB_PARAM = NB_ALL_PARAM - FIRST_PARAM };
