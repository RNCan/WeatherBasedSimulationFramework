...
void CGradientChartWnd::CreateToolBar()
{
	...
	m_wndToolBar.Create(this, AFX_DEFAULT_TOOLBAR_STYLE | CBRS_TOOLTIPS | CBRS_FLYBY, IDR_WEIGHT_GRAPH_TOOLBAR);
	m_wndToolBar.LoadToolBar(IDR_WEIGHT_GRAPH_TOOLBAR, 0, 0, TRUE);
...
void CGradientChartWnd::OnUpdateToolbar(CCmdUI *pCmdUI)
{
	...
	switch (pCmdUI->m_nID)
	{
	case ID_GRAPH_COPY:				pCmdUI->Enable(bInit); break;
