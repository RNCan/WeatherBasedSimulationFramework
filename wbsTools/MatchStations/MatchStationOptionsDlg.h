...
class CMatchStationOptionsDlg : public CMFCPropertySheet
{
	DECLARE_DYNAMIC(CMatchStationOptionsDlg)

    enum TPane{LAST_OPEN=-1, LINKS, TIME_FORMAT};

// Construction
public:
	CMatchStationOptionsDlg(CWnd* pParentWnd = NULL, UINT iSelectPage = LAST_OPEN);
	virtual ~CMatchStationOptionsDlg();

// Attributes
public:

    COptionLinks m_links;
	COptionTimeFormat m_timeFormat;
...
// Overrides
	...
	//{{AFX_VIRTUAL(CMatchStationOptionsDlg)
	//}}AFX_VIRTUAL
