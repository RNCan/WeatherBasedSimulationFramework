...
namespace WBSF
{
	...
	public:
		...
		//enum TNAME{ ALL = NB_PROVINCES, NB_TAG };
		enum TInfo{ ABVR, NAME, TITLE, NB_INFO};
		//enum TNAME{ ALBERTA, BRITISH_COLUMBIA, MANITOBA, NEW_BRUNSWICK, NEWFOUNDLAND, NORTHWEST_TERRITORIES, NOVA_SCOTIA, NUNAVUT, ONTARIO, PRINCE_EDWARD_ISLAND, QUEBEC, SASKATCHEWAN, YUKON, ALL, NB_TAG };
