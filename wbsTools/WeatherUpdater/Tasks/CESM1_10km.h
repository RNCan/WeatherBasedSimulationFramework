...
class CCESM1_CAM5_10km_MMGCreator : public CToolsBase
{
public:
	...
	CCESM1_CAM5_10km_MMGCreator(void);
	~CCESM1_CAM5_10km_MMGCreator(void);

	void Reset();
	CCESM1_CAM5_10km_MMGCreator& operator =(const CCESM1_CAM5_10km_MMGCreator& in);
	bool operator ==(const CCESM1_CAM5_10km_MMGCreator& in)const;
	bool operator !=(const CCESM1_CAM5_10km_MMGCreator& in)const;
