...
//**************************************************************
class CCompareNormalData: public CToolsBase
{
public:
	...
	CCompareNormalData(void);
	virtual ~CCompareNormalData(void);
	CCompareNormalData(const CCompareNormalData& in);

	virtual void InitClass(const CStringArray& option = EMPTY_OPTION);

	void Reset();
	CCompareNormalData& operator =(const CCompareNormalData& in);
	bool operator ==(const CCompareNormalData& in)const;
	bool operator !=(const CCompareNormalData& in)const;
