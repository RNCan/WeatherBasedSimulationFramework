...
class CHadGEM2_10km_MMGCreator : public CToolsBase
{
public:
	...
	CHadGEM2_10km_MMGCreator(void);
	~CHadGEM2_10km_MMGCreator(void);

	void Reset();
	CHadGEM2_10km_MMGCreator& operator =(const CHadGEM2_10km_MMGCreator& in);
	bool operator ==(const CHadGEM2_10km_MMGCreator& in)const;
	bool operator !=(const CHadGEM2_10km_MMGCreator& in)const;
