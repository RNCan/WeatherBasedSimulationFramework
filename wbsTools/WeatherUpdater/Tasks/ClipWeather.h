...
namespace WBSF
{
	...
	public:
		...
		enum TAttributes { INPUT_FILEPATH, OUTPUT_FILEPATH, FIRST_YEAR, LAST_YEAR, INCLUDE_IDS, EXCLUDE_IDS, BOUNDING_BOX, SHAPEFILE, LOC_FILEPATH, VARIABLES, NB_ATTRIBUTES };
