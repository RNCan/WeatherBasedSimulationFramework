...
namespace WBSF
{
	...
	public:
		...
		enum TAttributes { WORKING_DIR, HRDPS_VARS_SFC, HRDPS_VARS_AGL, HRDPS_VARS_ISBL, HRDPS_VARS_OTHERS, HRDPS_AGL_HEIGHTS, HRDPS_ISBL_LEVELS, COMPUTE_HOURLY_PRCP, UPDATE_LAST_N_DAYS, NB_ATTRIBUTES };
