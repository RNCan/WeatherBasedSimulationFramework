...
class CMIROC_10km_MMGCreator : public CToolsBase
{
public:
	...
	CMIROC_10km_MMGCreator(void);
	~CMIROC_10km_MMGCreator(void);

	void Reset();
	CMIROC_10km_MMGCreator& operator =(const CMIROC_10km_MMGCreator& in);
	bool operator ==(const CMIROC_10km_MMGCreator& in)const;
	bool operator !=(const CMIROC_10km_MMGCreator& in)const;
