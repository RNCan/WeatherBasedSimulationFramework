...
//*********************************************************************
const char* CCESM1_CAM5_10km_MMGCreator::ATTRIBUTE_NAME[] = { "INPUT_PATH", "OUTPUT_FILEPATH"};
const char* CCESM1_CAM5_10km_MMGCreator::CLASS_NAME = "CESM1_CAM5_10KM_MMG_CREATOR";


CCESM1_CAM5_10km_MMGCreator::CCESM1_CAM5_10km_MMGCreator(void)
{
...
void CCESM1_CAM5_10km_MMGCreator::InitClass(const StringVector& option)
{
	GetParamClassInfo().m_className = GetString(IDS_SOURCENAME_CESM1_CAM5_10_EXTRACTOR);
	...
	StringVector properties(IDS_PROPERTIES_CESM1_CAM5_10_EXTRACTOR, ";|");
...
//CCESM1_CAM5_10km_MMGCreator::CCESM1_CAM5_10km_MMGCreator(const CCESM1_CAM5_10km_MMGCreator& in)
//{
//	operator=(in);
//}

void CCESM1_CAM5_10km_MMGCreator::Reset()
{
	m_path.clear();
	//m_inputRCP = "RCP 8.5";
...
CCESM1_CAM5_10km_MMGCreator& CCESM1_CAM5_10km_MMGCreator::operator =(const CCESM1_CAM5_10km_MMGCreator& in)
{
	if( &in != this)
	{
...
bool CCESM1_CAM5_10km_MMGCreator::operator ==(const CCESM1_CAM5_10km_MMGCreator& in)const
{
	bool bEqual = true;
...
string CCESM1_CAM5_10km_MMGCreator::GetValue(size_t type)const
{
	string str;
...
void CCESM1_CAM5_10km_MMGCreator::SetValue(size_t type, const string& str)
{
	ASSERT( NB_ATTRIBUTE == 2); 
	switch(type)
	{
...
bool CCESM1_CAM5_10km_MMGCreator::Compare(const CParameterBase& in)const
{
	ASSERT(in.GetClassID() == GetClassID() );
	const CCESM1_CAM5_10km_MMGCreator& info = dynamic_cast<const CCESM1_CAM5_10km_MMGCreator&>(in);
	return operator==(info);
}

CParameterBase& CCESM1_CAM5_10km_MMGCreator::Assign(const CParameterBase& in)
{
	ASSERT(in.GetClassID() == GetClassID() );
	const CCESM1_CAM5_10km_MMGCreator& info = dynamic_cast<const CCESM1_CAM5_10km_MMGCreator&>(in);
	return operator=(info);
...
ERMsg CCESM1_CAM5_10km_MMGCreator::Execute(CFL::CCallback& callback)
{
	ERMsg msg;
...
const char* CCESM1_CAM5_10km_MMGCreator::VARIABLES_NAMES[NB_VARIABLES] = { "tmin", "tmax", "prec", "vapr", "swind" };//, "srad" 
const char* CCESM1_CAM5_10km_MMGCreator::RCP_NAME[NB_RCP] = { "rcp26", "rcp45", "rcp85" };



string CCESM1_CAM5_10km_MMGCreator::GetFileName(int period, int RCP, int var)
{
	string name;
	if (period == HISTORICAL)
		name = string("ncarcesm1_hist_") + VARIABLES_NAMES[var] + "_abs_1951-2005.nc";
	else
		name = string("ncarcesm1_") + RCP_NAME[RCP] + "_" + VARIABLES_NAMES[var] + "_abs_2006-2100.nc";

	return name;
}
string CCESM1_CAM5_10km_MMGCreator::GetProjectionWKT()
{
...
CGeoExtents CCESM1_CAM5_10km_MMGCreator::GetGCM10Extents()
{
	CGeoExtents extents;
...
void CCESM1_CAM5_10km_MMGCreator::GetOptions(CBaseOptions& options)
{
...
void CCESM1_CAM5_10km_MMGCreator::ConvertData(CMonthlyVariable& data)const
{
...
string CCESM1_CAM5_10km_MMGCreator::GetFilePath( string fileTitle)
{
...
ERMsg CCESM1_CAM5_10km_MMGCreator::CreateMMG(int rcp, CMonthlyMeanGrid& MMG, CFL::CCallback& callback)
{
	ERMsg msg;
	...
	for (int b = 0; b < options.m_nbBands; b++)
...
void CCESM1_CAM5_10km_MMGCreator::GetDEM(CFL::CMatrix<float>& DEM)
{
