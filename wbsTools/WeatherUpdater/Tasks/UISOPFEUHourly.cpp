...
namespace WBSF
{
	...
	//{ "TAi000H", "TAn000H", "TAx000H", "TAm000H", "PC040H", "PT040H", "PC020H", "PT041H", "HAi000H", "HAn000H", "HAx000H", "NSi000H", "VDi300H", "VVi300H", "VVxi500H", "VDm025B", "VVm025B", "TDi000H", "VB000B" };
	const TVarH CUISOPFEUHourly::VARIABLE[NB_FIELDS] = { H_TAIR2, H_TMIN2, H_TMAX2, H_TAIR2, H_SKIP, H_PRCP, H_SKIP, H_SWE, H_RELH, H_RELH, H_RELH, H_SNDH, H_WNDD, H_WNDS, H_SKIP, H_SKIP, H_WND2, H_TDEW, H_SKIP };
	...
	std::string CUISOPFEUHourly::Default(size_t i)const
	{
		...
		switch (i)
		{
		case WORKING_DIR: str = m_pProject->GetFilePaht().empty() ? "" : GetPath(m_pProject->GetFilePaht()) + "SOPFEU\\"; break;
		case FIRST_YEAR:
