...
namespace WBSF
{
	...
	//**************************************************************
	class CUIURMA : public CTaskBase
	{

	public:

		enum TProduct {RTMA, URMA, NB_PRODUCT};
		enum TAttributes { WORKING_DIR, PRODUCT, NB_ATTRIBUTES };

		static const char* CLASS_NAME();
		static CTaskPtr create(){ return CTaskPtr(new CUIURMA); }
		static CTRef GetTRef(std::string filePath);
		
		CUIURMA(void);
		virtual ~CUIURMA(void);
