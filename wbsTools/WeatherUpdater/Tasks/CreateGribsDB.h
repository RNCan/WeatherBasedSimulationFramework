...
namespace WBSF
{
	...
	public:
		...
		enum TMerge {FIRST_AVAIL, ALL_AVAIL };
		enum TATTRIBUTE { MERGE_TYPE, INPUT1, INPUT2, INPUT3, FORECAST1, FORECAST2, FORECAST3, OUTPUT, FIRST_DATE, LAST_DATE, NB_ATTRIBUTES };
