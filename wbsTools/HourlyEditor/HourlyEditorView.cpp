...
CHourlyEditorDoc* CDPTView::GetDocument() const // non-debug version is inline
{
...
{
	//CHourlyEditorDoc* pDocument = pDocument = GetDocument(); ASSERT(pDocument);
	...
	//			//remove old data
	//			
	//			pDocument->UpdateAllViews(NULL, CHourlyEditorDoc::DEFINITION_CHANGE, NULL);
	//		}
	//		
	//	}
	//}
