...
//*****************************
	...
	periodEnabled.SetStyle(TBBS_CHECKBOX);//& ~WS_GROUP
	ReplaceButton(ID_GRAPH_PERIOD_ENABLED, periodEnabled);
//*****************************
	CMFCToolBarDateTimeCtrl periodBegin(ID_GRAPH_PERIOD_BEGIN, 5, DTS_SHORTDATECENTURYFORMAT);
	ReplaceButton(ID_GRAPH_PERIOD_BEGIN, periodBegin);
//*****************************
	CMFCToolBarDateTimeCtrl periodEnd(ID_GRAPH_PERIOD_END, 6, DTS_SHORTDATECENTURYFORMAT );
...
//*****************************
	CMFCToolBarComboBoxButton statButton(ID_GRAPH_STAT, CBS_DROPDOWNLIST );
...
void CWeatherChartWnd::OnUpdate(CView* pSender, LPARAM lHint, CObject* pHint)
{
	...
	if (lHint == CHourlyEditorDoc::INIT || lHint == CHourlyEditorDoc::CHARTS_PROPERTIES_ZOOM_CHANGE)
	{
	...
	if (lHint == CHourlyEditorDoc::INIT || lHint == CHourlyEditorDoc::PROPERTIES_TM_CHANGE)
	{
