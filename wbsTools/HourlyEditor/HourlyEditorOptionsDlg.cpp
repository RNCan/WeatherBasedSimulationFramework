...
IMPLEMENT_DYNAMIC(CHourlyEditorOptionsDlg, CMFCPropertySheet)

CHourlyEditorOptionsDlg::CHourlyEditorOptionsDlg(CWnd* pParentWnd, UINT iSelectPage)
...
CHourlyEditorOptionsDlg::~CHourlyEditorOptionsDlg()
{
}


BEGIN_MESSAGE_MAP(CHourlyEditorOptionsDlg, CMFCPropertySheet)
	ON_BN_CLICKED(IDOK, OnFinish)
	ON_WM_DESTROY()
END_MESSAGE_MAP()

/////////////////////////////////////////////////////////////////////////////
// CHourlyEditorOptionsDlg message handlers
void CHourlyEditorOptionsDlg::OnFinish()
{
	m_nModalResult = IDOK;
...
void CHourlyEditorOptionsDlg::OnDestroy() 
{
...
BOOL CHourlyEditorOptionsDlg::OnInitDialog()
{
