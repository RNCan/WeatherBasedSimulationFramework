...
CHourlyEditorDoc* COutputView::GetDocument() const
{
...
void COutputView::OnUpdate(CView* pSender, LPARAM lHint, CObject* pHint)
{
	...
	if (lHint == CHourlyEditorDoc::INIT || lHint == CHourlyEditorDoc::OUTPUT_CHANGE)//|| lHint == CHourlyEditorDoc::SELECTION_CHANGE || lHint == CHourlyEditorDoc::TASK_CHANGE
	{
