...
namespace WBSF
{
	...
	enum TAnnual{ A_TMIN, A_N, A_Q3, A_DDpro, A_EQ1, A_EQ2, A_S, A_P, A_R, NB_OUTPUTS_A };
	...
	double CHemlockWoollyAdelgidCMModel::Eq5(double S, double Tmin, double DDpro)
	{
		if (S <= 0)
			return 0;
