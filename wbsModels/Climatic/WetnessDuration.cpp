...
double CDewDuration::GetΔT(double Rs, double RL,  double Ta, double hc, double hw,double P, double esa, double e)
{
	...
	static const double ∞[NB_CANOPY] = {0.17,0.23,0.24}; //albedo of the surface underneath the leaf 
	...
	double num = a*Rs*(1+∞[m_canopy]) + ϵ*RL - ϵ*σ*Quart(Ta + 273) - (0.622/P)*2*hw*(esa-e);
