...
namespace WBSF
{
	...
	const double CBlueStainIndexModel::PERCENTILS[CBlueStainVariables::NB_VARIABLES][NB_LIMITS] =
	{
		...
		*/
		...
		{ -2.3, 3.8, 9.9, 11.7 },
		{ 3.7, 8.3, 14.4, 16.2 },
		{ 128.3, 526.0, 1383.4, 1816.4 },
		{ 11.1, 13.9, 19.1, 20.9 },
		{ -23.2, -7.2, 2.2, 4.1 },
		{ -3.9, 3.3, 18.2, 20.9 },
		{ -23.2, -6.2, 11.6, 18.2 },
		{ 42.3, 105.0, 344.0, 597.4 },
		{ 7.5, 34.8, 216.2, 490.2 },
		{ 37.8, 130.2, 363.8, 569.2 },
		{ 7.5, 33.4, 137.8, 170.3 },
		{ -1310.8, -907.0, -39.6, 337.9 },
		{ -449.9, -167.6, 97.6, 187.6 },
		{ -606.5, -339.3, -45.4, 10.2 },
		{ -606.5, -403.8, 40.6, 161.2 },
		{ -266.6, -135.4, 37.7, 178.4 },
		{ 12.0, 14.7, 20.4, 22.4 },
		{ -24.3, -10.1, 0.3, 2.6 },
		{ 22.0, 88.1, 287.9, 431.1 },
		{ 1.2, 3.7, 46.2, 63.6 },
		{ 593.2, 961.8, 1767.1, 1983.5 }
*/
//10-90 new database
		{-8.6, -0.3, 5.2, 7.3},
		{ -2.3, 3.7, 9.9, 11.7 },
