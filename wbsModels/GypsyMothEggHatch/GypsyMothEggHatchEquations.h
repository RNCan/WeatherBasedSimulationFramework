...
namespace WBSF
{
	...
	namespace LNF
	{
		...
		enum TEOD{ Distribution, DOYb, DOYe, μ, ѕ, ALPHA, NCDDb, NCDDe, Τᴴ¹, Τᴴ², SIGMAb, SIGMAe, NB_EOD_PARAMS};//End Of Diapause (egg development begin)
	...
	public:
		...
		//default parameters
		static const std::array<double, LNF::NB_EOD_PARAMS> EOD;//Default End Of Diapause (egg development begin) parameters
		static const std::array<double, LNF::NB_EDP_PARAMS> EDP;//Default Egg development parameters
		static const std::array<double, LNF::NB_RDR_PARAMS> RDR;//Default End Of Diapause (egg development begin) parameters
		
		//variable parameters for calibration
		std::array<double, LNF::NB_EOD_PARAMS> m_EOD;//End Of Diapause (egg development begin) parameters
		std::array<double, LNF::NB_EDP_PARAMS> m_EDP;//Egg development parameters
		std::array<double, LNF::NB_RDR_PARAMS> m_RDR;//End Of Diapause (egg development begin) parameters
