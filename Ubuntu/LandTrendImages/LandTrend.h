...
namespace WBSF
{
	...
	public:
		...
		CExtractPoint(const std::string& file_path, const std::vector<CGeoPoint>& pts = std::vector<CGeoPoint>())
		{
	...
	public:
		...
		std::string m_extract_points_file_path;
