...
//#pragma omp atomic treadNo[thread] = true;
        ...
        Landsat2::CLandsatWindow bandHolder;
        OutputData outputData;
        DebugData debugData;
        ReadBlock(inputDS, xBlock, yBlock, bandHolder);
        ProcessBlock(xBlock, yBlock, bandHolder, validity, outputData, debugData);
...
void CLandTrend::ReadBlock(Landsat2::CLandsatDataset& inputDS, int xBlock, int yBlock, Landsat2::CLandsatWindow& block_data)
{
    #pragma omp critical(BlockIO)
    {
        ...
        inputDS.CGDALDatasetEx::ReadBlock(extents, block_data, int(ceil(m_options.m_rings)), m_options.m_IOCPU/*, first_layer, size_t nb_layer*/);
