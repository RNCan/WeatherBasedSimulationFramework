...
pdf(file=file_name, height=11, width=8.5, pointsize = 12, family = myfont[font_sel])
	...
	text(0.5,0.55, adj=c(0,0.5), expression(T[b]~'°C'~~~~bgroup('(',or~T[k[b]]~'°K',')')), family = myfont[font_sel], cex = 1.5)
	text(0.1,0.5, adj=c(0,0.5), expression("Optimum"), family = myfont[font_sel], cex = 1.5)
	text(0.5,0.5, adj=c(0,0.5), expression(T[o]~'°C'~~~~bgroup('(',or~T[k[o]]~'°K',')')), family = myfont[font_sel], cex = 1.5)
	text(0.1,0.45, adj=c(0,0.5), expression("Upper"), family = myfont[font_sel], cex = 1.5)
	text(0.5,0.45, adj=c(0,0.5), expression(T[m]~'°C'~~~~bgroup('(',or~T[k[m]]~'°K',')')), family = myfont[font_sel], cex = 1.5)
